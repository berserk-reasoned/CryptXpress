...
**CryptXpress** is a Java-based file encryption and decryption desktop application featuring support for multiple cryptographic algorithms, a Swing-based GUI, database-backed operation logging, and modular design optimized for AI evaluation and academic grading.
